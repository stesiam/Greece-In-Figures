...
title_text = glue("<b>Pharmacies in Greece</b>")
subtitle_text = glue("Number of pharmacies by 10,000 regional population")
caption_text = glue("*Data of:* 2022 <br><b> Data:</b> Panhellenic Pharmaceutical Association<br><span style='font-family:fb;'  >&#xf09b;</span> <b>stesiam</b>, 2023")
...
map = ggplot2::ggplot(data = data_shp_join) +
  ...
  theme(
    plot.title = element_markdown(family = "clim", hjust = 0.5, size = 20,
                                  ...
                                  color = "white"),
    plot.subtitle = element_markdown(size = 9, family = "mont", hjust = 0.5, 
