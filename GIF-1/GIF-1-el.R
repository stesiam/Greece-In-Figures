...
title_text = glue("<b>Κατά κεφαλήν ΑΕΠ</b>")
subtitle_text = glue("Το κατά κεφαλήν ΑΕΠ ανά περιφέρεια (2021) δείχνει το μέσο επίπεδο πλούτου των κατοίκων της αντίστοιχης περιοχής.
                        Η **Αττική**, η **Στερεά Ελλάδα** και τα **νησιά του Νότιου Αιγαίου** είναι οι περιφέρειες με υψηλότερο κατά κεφαλήν ΑΕΠ.
                        Από την άλλη μεριά, οι περιφέρειες των **Βορείου Αιγαίου**, της **Ηπείρου** και της **Ανατολικής Μακεδονίας-Θράκης** &nbsp;&nbsp;&nbsp; έχουν κατά μέσο όρο τους πιο φτωχούς κατοίκους σε σχέση με τις υπόλοιπες περιφέρειες .")
caption_text = glue("*Δεδομένα χρονιάς:* 2021 | *Έτος βάσης:* &nbsp; 2015 | Σε χιλιάδες ευρώ €<br><b> Δεδομένα:</b> Ελληνική Στατιστική Υπηρεσία<br><span style='font-family:fb;'  >&#xf09b;</span> <b>stesiam</b>, 2023")
...
map = ggplot2::ggplot(data = matched_data) +
  ...
  theme(
    ...
    plot.subtitle = element_textbox_simple(size = 10.6, family = "serif", hjust = 0.5, 
                                           lineheight = 1.2),
