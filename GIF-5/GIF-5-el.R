...
caption_text = glue("*Μονάδα μέτρησης:* Λίτρα/κάτοικο <br>**Δεδομένα χρονιάς:* 2022- Περιφερειακός πληθυσμός βασίζεται στην απογραφή του 2021<br><b> Πηγή:</b> Υπουργείο Περιβάλλοντος και Ενέργειας <br><span style='font-family:fb;'  >&#xf09b;</span> <b>stesiam</b>, 2023")
